...
public class UtilTest {
	...
	public void testFemaleMolesGroups() {
		assertEquals(0 + ": ",Util.MOLES_RARM_0,Util.femaleMolesGroups(0));
		
		assertEquals(1 + ": ",Util.MOLES_RARM_1,Util.femaleMolesGroups(1));
		assertEquals(2 + ": ",Util.MOLES_RARM_2,Util.femaleMolesGroups(2));
		assertEquals(3 + ": ",Util.MOLES_RARM_3PLUS,Util.femaleMolesGroups(3));
		assertEquals(4 + ": ",Util.MOLES_RARM_3PLUS,Util.femaleMolesGroups(4));
		assertEquals(99 + ": ",Util.MOLES_RARM_3PLUS,Util.femaleMolesGroups(99));
