package ac.otago.infoscience.mcws.test;
...
import ac.otago.infoscience.mcws.Calculator;
import ac.otago.infoscience.mcws.Table3;
import ac.otago.infoscience.mcws.Util;
...
public class CalculatorTest {
	...
	void initResultsMen() {
		...
		resultsMenA[0][2] = 0.0795f;
		//resultsMenA[0][2] = 0.07740f;
		
		resultsMenA[0][3] = 0.1485f;
		//resultsMenA[0][3] = 0.1493f;

		resultsMenA[1][0] = 0.0015f;
		resultsMenA[1][1] = 0.0107f;
		
		resultsMenA[1][2] = 0.0770f;
		//resultsMenA[1][2] = 0.0774f;
		
		
		resultsMenA[1][3] = 0.1596f;
	...
	public void testCalculateFemale() {
		...
		int[] A = { Util.SKINCOLOUR_FAIR, Util.FAMHXMOLES_YES,
				Util.MOLES_RARM_3PLUS, Util.NMSC_YES_F, 20, Util.AREA_NORTH };
		System.out.println("running testCalculateFemale A");
		runTestsFemale(A, resultsWomenA);

		// MEDIUM RISK
		int[] B = { Util.SKINCOLOUR_FAIR, Util.FAMHXMOLES_NO,
				Util.MOLES_RARM_2, Util.NMSC_NO_F, 20, Util.AREA_NORTH };
		System.out.println("running testCalculateFemale B");
		runTestsFemale(B, resultsWomenB);

		// LOW RISK
		int[] C = { Util.SKINCOLOUR_OLIVE, Util.FAMHXMOLES_DONTKNOW,
	...
	public void testCalculateMale() {
		...
		int[] A = { 5, Util.NMSC_YES_M, Util.OCCUPATION_OUT, Util.BIRTH_NZ, Util.AGE_50_OR_LESS, 20, Util.AREA_NORTH };
		System.out.println("running testCalculateMale A");
		runTestsMaleYoung(A, resultsMenA);

		int[] A2 = {5, Util.NMSC_YES_M, Util.OCCUPATION_OUT, Util.BIRTH_NZ, Util.AGE_51_OR_MORE, 60, Util.AREA_NORTH};
		System.out.println("running testCalculateMale A2");
		runTestsMaleOld(A2, resultsMenA);

		// MEDIUM RISK
		int[] B = { 1, Util.NMSC_YES_M, Util.OCCUPATION_INOUT, Util.BIRTH_NZ,Util.AGE_50_OR_LESS,  20, Util.AREA_NORTH };
	...
	public void testcalculateRiskCategory() {
		...
		assertEquals("2: ",Util.LOW_RISK ,Util.calculateRiskCategory(0.0027f));
		assertEquals("3: ",Util.MODERATE_RISK ,Util.calculateRiskCategory(0.0028f));
