 ...
 * 
 */
public class HelpPanel extends VerticalPanel implements ClickHandler {
	...
	public HelpPanel(Form1 parent) {
		...
		verticalPanel.add(new Image("/images/help/help1.png"));
		verticalPanel.add(new Image("/images/help/tree.png"));
		
		verticalPanel.add(new Image("/images/help/help2.png"));
		verticalPanel.add(new Image("/images/help/detailsmother.png"));
		
		verticalPanel.add(new Image("/images/help/help3.png"));
		verticalPanel.add(new Image("/images/help/calculaterisk.png"));
		
		verticalPanel.add(new Image("/images/help/help4.png"));
		
		
		
		Button closeButton = new Button("Close this help screen");
