...
public class EntryPanel extends VerticalPanel {
	...
	public EntryPanel(DetailsPanel[] details) {
		super();
		this.details = details;
		
	}

	public void setWhoIsClicked(int who) {
		this.clear();
		if (who > -1) {
			this.add(details[who]);
			details[who].setVisible(true);
			details[who].setFocus();
		}
	}
