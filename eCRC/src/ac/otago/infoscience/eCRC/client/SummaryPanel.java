		...
		public SummaryPanel(  CancerHistory[] histories) {
			...
			super();
				...
				for (int i = 1; i <= instances; i++) {
					...
					deceasedCheckBox.setEnabled(false);
					deceasedCheckBox.setValue(histories[i-1].isDeceased());
					...
					ageDeceasedTextBox.setValue(histories[i-1].getdAgeString());
