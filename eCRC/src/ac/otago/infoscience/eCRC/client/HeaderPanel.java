...
public class HeaderPanel extends VerticalPanel implements ClickHandler {
	...
	String sdhbURL = "http://www.southerndhb.govt.nz/";
	String sdhbTitle = "Southern District Health Board";
	...
	HeaderPanel(String mode) {
		...
		if (mode.equals(Util.HEADER_MODE_NARROW)) {
			headerImage = new Image("images/header-narrow.png");
		} else {
			headerImage = new Image("images/header.png");
		}
