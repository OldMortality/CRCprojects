...
public class RiskCalculatorTestCases {
	...
	public void testcase52() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.PAT_GRANDFATHER, "Fred", false, (short) -1, false,
				true, (short) 52, false, (short) -1, "");
		
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.FATHER, "Fred", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		
		CancerHistory h3 = new CancerHistory("NHI123", "eref1",
				(short) Util.PAT_AUNTIES, "Fred", false, (short) -1, false,
				true, (short) 51, false, (short) -1, "");
		
		
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 52 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase53() {
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 53 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase54() {
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 54 ", 3 , riskCalculator.calculateRisk());
	...
	@Ignore
		...
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.MOTHER, "Eva", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_AUNTIES, "Rita", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		
		CancerHistory h3 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_AUNTIES, "Jo", false, (short) -1, false,
				true, (short) 51, false, (short) -1, "");
		
		
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 55 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase56() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.MOTHER, "Eva", false, (short) -1, false,
				true, (short) 53, false, (short) -1, "");
		
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_GRANDMOTHER, "Rita", false, (short) -1, false,
				true, (short) 53, false, (short) -1, "");
		
		CancerHistory h3 = new CancerHistory("NHI123", "eref1",
				(short) Util.SIBLINGS, "Fred", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		
		
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 56 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase57() {
		...
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.FATHER, "Rita", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 57 ", 0, riskCalculator.calculateRisk());
	...
	public void testcase58() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.CHILDREN, "Fred", false, (short) -1, false,
				true, (short) 44, false, (short) -1, "");
		
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.CHILDREN, "Rita", false, (short) -1, false,
				true, (short) 44, false, (short) -1, "");
		
		CancerHistory h3 = new CancerHistory("NHI123", "eref1",
				(short) Util.CHILDREN, "Jo", false, (short) -1, false,
				true, (short) 44, false, (short) -1, "");
		
		
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 58 ", 0 , riskCalculator.calculateRisk());
	...
	public void testcase59() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.MOTHER, "Fred", false, (short) -1, false,
				true, (short) 45, false, (short) -1, "");
		...
		CancerHistory h5 = new CancerHistory("NHI123", "eref1",
				(short) Util.SIBLINGS, "Rita", false, (short) -1, false,
				true, (short) 44, false, (short) -1, "");
		...
		CancerHistory[] td1 = { h1, h2, h3, h4, h5, h6};
		manager.setHistories(td1);
		assertEquals("case 59 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase60() {
		...
		CancerHistory[] td1 = { h1, h2, h3, h4, h5};
		manager.setHistories(td1);
		assertEquals("case 60 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase61() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_GRANDFATHER, "Fred", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		...
		CancerHistory h3 = new CancerHistory("NHI123", "eref1",
				(short) Util.MOTHER, "Eva", true, (short) 51, false,
				true, (short) 51, false, (short) -1, "");
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 61 ", 3 , riskCalculator.calculateRisk());
	...
	public void testcase62() {
		CancerHistory h1 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_GRANDMOTHER, "Fred", false, (short) -1, false,
				true, (short) 51, false, (short) -1, "");
		
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.MAT_GRANDFATHER, "Rita", false, (short) -1, false,
				true, (short) 49, false, (short) -1, "");
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 62 ", 0 , riskCalculator.calculateRisk());
	...
	public void testcase63() {
		...
		CancerHistory h2 = new CancerHistory("NHI123", "eref1",
				(short) Util.PAT_GRANDMOTHER, "Rita", false, (short) -1, false,
				true, (short) 50, false, (short) -1, "");
		...
		CancerHistory[] td1 = { h1, h2, h3};
		manager.setHistories(td1);
		assertEquals("case 62 ", 3 , riskCalculator.calculateRisk());
