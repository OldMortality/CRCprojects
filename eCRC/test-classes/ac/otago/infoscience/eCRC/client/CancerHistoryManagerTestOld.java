...
public class CancerHistoryManagerTestOld {
	...
	public static void initCancerHistories() {
		...
		Vector<CancerHistory> testdata4 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata5 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata6 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata7 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata8 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata9 = new Vector<CancerHistory>();
		...
		// *****************
		Vector<CancerHistory> testdata10 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata11 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata12 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata13 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata14 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata15 = new Vector<CancerHistory>();
		...
		Vector<CancerHistory> testdata16 = new Vector<CancerHistory>();
