...
public class DisclaimerPanel extends VerticalPanel implements ClickHandler {

	Button agreeButton = new Button("I agree");
	Button disagreeButton = new Button("I disagree");

	Image disclaimerImage = new Image("images/disclaimer.png");
	...
	DisclaimerPanel(Form1 parent) {
		...
		this.add(disclaimerImage);
		this.add(buttonPanel);
		agreeButton.addClickHandler(this);
		//agreeButton.setStylePrimaryName("agreeButtonStyle");
		//disagreeButton.addClickHandler(this);

		/* link to guidelines disabled.
		 * 
		disclaimerImage.addClickHandler(new ClickHandler() {

			public void onClick(ClickEvent event) {

				Window.open(Util.URL_GUIDELINES, "Guidelines", "_blank");
	...
	@Override
	public void onClick(ClickEvent event) {
		if (event.getSource().equals(agreeButton)) {
			parent.setAgreed();
		} 
